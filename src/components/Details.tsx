...
export default function Details({maxTemp , minTemp ,cloudy,humidity ,wind,searchCity,setCity,city,getWeather , condition , cloud9,cloud15,cloud18,cloud21} : PropType) {
  ...
  return (
    <div className="flex bg-transparent flex-col overflow-hidden items-center  bg-cover bg-center backdrop-blur-sm  p-[35.6px] shadow-lg   [@media_(min-width:1050px)_and_(max-width:1736px)]:absolute top-0 right-0  [@media_(min-width:1050px)_and_(max-width:1736px)]:gap-5 [@media_(min-width:1050px)_and_(max-width:1736px)]:h-screen [@media_(min-width:1050px)_and_(max-width:1736px)]:border-none ">
