...
export default function Details({maxTemp , minTemp ,cloudy,humidity ,wind,searchCity,setCity,city,getWeather , condition , cloud9,cloud15,cloud18,cloud21} : PropType) {
  ...
  return (
    <div className="flex absolute bottom-0 [@media_(min-width:1px)_and_(max-width:1050px)]:left-1/2 [@media_(min-width:1px)_and_(max-width:1050px)]:transform [@media_(min-width:1px)_and_(max-width:1050px)]:-translate-x-1/2 backdrop-blur-md  bg-white/15  shadow-lg justify-self-end [@media_(min-width:1px)_and_(max-width:1050px)]:w-full flex-col  overflow-hidden items-center  bg-cover bg-center   p-[35.6px] [@media_(min-width:1050px)_and_(max-width:1736px)]:absolute [@media_(min-width:1050px)_and_(max-width:1736px)]:top-0 [@media_(min-width:1050px)_and_(max-width:1736px)]:right-0  [@media_(min-width:1050px)_and_(max-width:1736px)]:gap-5 [@media_(min-width:1050px)_and_(max-width:1736px)]:h-screen [@media_(min-width:1050px)_and_(max-width:1736px)]:border-none ">
